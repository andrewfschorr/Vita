...
var Welcome = function (_Component) {
    ...
    _createClass(Welcome, [{
        ...
        value: function handleSubmit(event) {
            ...
            var isValidEmail = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(this.state.value.trim());
            if (this.state.value.trim() === '' || !isValidEmail) return;

            _axios2.default.post('/subscribe-splash', {
                email: this.state.value
            }, {
                withCredentials: true
            }).then(function (response) {
                if (response.status === 200) {
                    _this2.setState({ succesfulSubmit: true });
                } else {
                    _this2.setState({ succesfulSubmit: 'error' });
                }
            }).catch(function (error) {
                if (error.response.status === 500) {
                    _this2.setState({ succesfulSubmit: 'error' });
                } else {
                    _this2.setState({ succesfulSubmit: 'duplicate' });
                }
                console.log(error);
            });
        }
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'col-md-4 offset-md-8 t-right' },
                        _react2.default.createElement(
                            'h3',
                            null,
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'col-md-10 offset-md-2 t-right' },
                        _react2.default.createElement(
                            'h2',
                            { className: 'bold' },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'col-8' },
                        !this.state.succesfulSubmit ? _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'small',
                                    { id: '', className: 'sub-text' },
                                    'Sign up for updates when we launch!'
                                )
                            )
                        ) : typeof this.state.succesfulSubmit === 'string' ? _react2.default.createElement(
                            'div',
                            ...
                            ' ',
                            this.state.succesfulSubmit === 'duplicate' ? 'You may already be subscribed.' : 'There was an erorr processing your request.',
                            ' ',
                            '\uD83D\uDE2C'
                        ) : _react2.default.createElement(
                            'div',
...
if (document.getElementById('splashCpt')) {
    _reactDom2.default.render(_react2.default.createElement(Welcome, null), document.getElementById('splashCpt'));
}
